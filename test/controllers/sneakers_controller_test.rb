...
class SneakersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sneaker" do
    assert_difference('Sneaker.count') do
      post sneakers_url, params: { sneaker: { description: @sneaker.description, name: @sneaker.name, price: @sneaker.price } }
    end
  ...
  test "should update sneaker" do
    patch sneaker_url(@sneaker), params: { sneaker: { description: @sneaker.description, name: @sneaker.name, price: @sneaker.price } }
